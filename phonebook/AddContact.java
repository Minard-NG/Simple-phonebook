...
public class AddContact extends MouseAdapter implements ActionListener
{
    ...
    JTextField txt_name, txt_cno,txt_email;
    JLabel lbl_name, lbl_cno, name, no, lbl_ct,lbl_email;
    JButton btn_add;
    JList jl_contact;
    JScrollPane scroll;
    ...
    public AddContact() 
    {
        ...
        lbl_email = new JLabel("Enter your email address: ");
...
class NameSort implements Comparator<Contact>
{
    ...
    public void addComponentToAdd() 
    {
        ...
        lbl_email.setBounds(10,120,100,20);
        jf_AddContact.add(lbl_email);
        
        txt_email.setBounds(120,120,150,20);
        jf_AddContact.add(txt_email);

        btn_add.setBounds(120, 160, 100, 25);
    ...
    public void actionPerformed(ActionEvent ae) 
    {
     ...
     if (name.equals("") || (cno.equals("")) || (email.equals(""))) 
     {
